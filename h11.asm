...
;------------------VARIANT 2------------------------------------
    ...
    mov cx, 10                      ; Задаємо кількість ітерацій для циклу, який друкує рядки
    ...
    mov ax, 0B800h                  ; Запис початкової адреси відеопам'яті до bx 
    mov es, ax                      ; Запис ax до es

    mov di, dx                      ; Запис di до dx, початок виведення на екран
    ...
    add dx, 140                     ; Зміщ. наступного рядка
